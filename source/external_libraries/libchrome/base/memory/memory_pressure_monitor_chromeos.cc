...
int GetCriticalMemoryThresholdInPercent(
    MemoryPressureMonitor::MemoryPressureThresholds thresholds) {
  return thresholds ==
                     MemoryPressureMonitor::THRESHOLD_AGGRESSIVE_TAB_DISCARD ||
                 thresholds == MemoryPressureMonitor::THRESHOLD_AGGRESSIVE
...
MemoryPressureMonitor::MemoryPressureMonitor(
  ...
  // !low_mem_file_.is_valid())
  LOG_IF(ERROR, false) << "Cannot open kernel listener";
}
...
// static
MemoryPressureMonitor* MemoryPressureMonitor::Get() { return g_monitor; }
